...
class RouteHelpersTestCase(unittest.TestCase):
    ...
    def test_slice_step(self):
        result = road.slice_step(road.prep_directions(DIRECTIONS_RESULT_1999)["steps"][1], 0.1)
...
class RouteClassTestCase(unittest.TestCase):
    ...
    def test_Route_init(self):
        result = road.Route(road.prep_directions(DIRECTIONS_RESULT_899), "03:01", "tomorrow")
    ...
    def test_Route_fill_buckets(self):
        result = road.Route(road.prep_directions(DIRECTIONS_RESULT_1999), "03:01", "tomorrow")
        coords_time = result.make_coords_time()
